...
<li class="header-search  header-search-dropdown has-icon has-dropdown menu-item-has-children">
	...
	<ul class="nav-dropdown dra_input-field <?php flatsome_dropdown_classes(); ?>">
	 	<?php get_template_part('template-parts/header/partials/element-search-form'); ?>
	</ul>
	
	<div class="dra_header-icon"><i class="fa-solid fa-cart-shopping"></i></div>
	<div class="dra_header-icon"><i class="fa-solid fa-user"></i></i></div>
